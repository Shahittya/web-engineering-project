...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="dassssshboard/index.html" class="b-brand text-primary">
        <!-- ========   Change your logo from here   ============ -->
<img style="max-width: 66%;" src="img/LogoUMP.png" class="img-fluid" alt="logo">
      </a>
    </div>
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="assets/images/user/user1.jpg" alt="user-image" class="user-avtar">
                </div>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3"> <span class=""><i
                    class=""></i> </span></h4>
              <p class="mb-0 text-muted text-sm"> <span class="text-primary"></span> 
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3"> <span class=""><i
                    class=""></i></span></h4>
              <p class="mb-0 text-muted text-sm"> <span class="text-warning"></span> </p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3"> <span class=""><i
                    class=""></i> </span></h4>
              <p class="mb-0 text-muted text-sm"><span class="text-danger"></span> 
              </p>
            </div>
          </div>
        </div>
